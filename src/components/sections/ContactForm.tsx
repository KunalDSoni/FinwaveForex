    ...
    >
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          ...
          <select
            id="subject"
            className="border-input h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring sm:text-sm"
            {...register("subject")}
          >
